...
<div className="w-full flex md:justify-center justify-between items-center flex-col p-4  shadow-xl gradient-bg-footer">
      ...
      <div className="flex justify-center items-center text-center flex-col mt-5 rounded-xl .white-glassmorphism p-2 bg-gray-900 w-9/12" id="coffee">
        <p className="text-white text-center font-semibold  md:text-2xl sm:text-base"><strong className="flex flex-col justify-center items-center text-center text-lg pt-2 sm:text-2xl" id="come">Come Join Us For Technically Improved Transactions </strong> <br />   <main className="text-base font-semibold ">We are not alergic to Coffee Please!! But Real <b>ETH</b> <i>NOT FAUCETS PLEASE!!</i></main> <BiRightArrowAlt className="flex flex-col text-center text-[lightgreen] mb-4 mt-2 " fontSize={50}/> </p>
