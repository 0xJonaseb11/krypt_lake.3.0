...
<div className="w-full flex md:justify-center justify-between items-center flex-col p-4  shadow-xl gradient-bg-footer">
      ...
      <div className="flex justify-center items-center text-center flex-col mt-5 rounded-xl white-glassmorphism p-4 bg-[#9999] w-full" id="coffee">
        <p className="text-white text-center font-semibold  md:text-2xl sm:text-base"><d className="flex flex-col justify-start items-center text-center text-2xl pt-2 ">Come Join Us For Technically Improved Transactions</d> <br />   <main className="text-base font-semibold ">We Also Take Coffee Please!!! But Real <b>ETH</b> <i>NOT FAUCETS!</i></main> <BiRightArrowAlt className="flex flex-col text-center text-[lightgreen] mb-4 mt-2 " fontSize={50}/> </p>
        <p className="text-white text-center font-semibold  md:text-2xl sm:text-base"><BiWalletAlt className="flex flex-col justify-center text-white text-center items-center w-full border-0 -mt-16 " fontSize={50} /> <d className="flex flex-col justify-center items-center text-center text-base">My Wallet : </d> </p>
        ...
        <p className="text-white text-sm text-center font-medium mt-2"><a href="https://accounts.google.com" target="_blank" rel="noreferrer">info@krypt.com</a></p>
      </div>

      <div className="sm:w-[90%] w-full h-[0.5px] bg-gray-800 mt-10 shadow-xl" />

      <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
        <p className="text-[#9999] text-left text-xs">&#187; Krypt&#169;2023</p>
        <p className="text-[#9999] text-center text-xs ">All rights reserved</p>
        <p className="text-[#9999] text-left text-xs">&#187; jonassebera@gmail.com</p>
      </div>
